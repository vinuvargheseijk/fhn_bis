...
def makeSequence( numSpines ):
    ...
    if displayMoogli:
        ...
        #patterns = a[0::5]
        patterns = [[0,1,2,3,4],[4,0,3,2,1],[4,0,3,1,2],[3,0,4,1,2],[0,4,1,3,2],[3,1,2,0,4],[4,3,1,0,2],[1,2,0,3,4],[1,0,3,2,4],[4,0,2,1,3],[4,1,3,2,0],[4,1,3,0,2],[4,3,2,1,0]]
...
def scanDistDtGrid():
    ...
    for seqDt in seqDtRange:
        ...
        for d in drange:
            ...
            temp = []
            slopes = []
            print 'This is non tapered, no spine cell'
            pos = range(0,len(Z),1)
            print pos
            for seq in seqList:
                print '.',
                ...
                for j in range( numSpine ):
                    ...
                    print >>f1, '\t\tk: ', k 
                    Z[ k ].nInit = 1
                    print 'volumes are',Z[0].volume,Z[k-2].volume,Z[k-1].volume,Z[k].volume

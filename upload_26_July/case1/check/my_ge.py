    ...
    for seqDt in seqDtRange:
        ...
        for d in drange:
            ...
            for seq in seqList:
                print '.',
                sys.stdout.flush()
                print 'volume of first spine head is ', Z[startPos+1].volume, Z[61].volume, Z[59].volume
                for j in range( numSpine ):
                    ...
                    print >>f1, '\t\tk: ', k 
                    Z[ k ].nInit = 1
                    print 'volumes are',Z[k-2].volume,Z[k-1].volume,Z[k].volume,Z[k+1].volume,Z[k+2].volume,Z[61].volume
